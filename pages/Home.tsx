...
import { ArrowRight, Code2, Database, Brain, Phone } from 'lucide-react';
      ...
      <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40 w-full">
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl lg:flex-shrink-0 lg:pt-8">
          ...
          <h1 className="mt-10 text-4xl font-bold tracking-tight text-white sm:text-6xl">
            Building the future with <span className="text-emerald-400">Python & AI</span>
          </h1>
          ...
          >
            Hi, I'm <span className="text-white font-semibold">{RESUME_DATA.name}</span>. {RESUME_DATA.summary}
          </motion.p>
          <motion.div 
          ...
          >
            ...
            >
              <Phone className="mr-2 w-4 h-4 text-emerald-400 group-hover:rotate-12 transition-transform" /> Contact Me
            </a>
          </motion.div>
          ...
          >
             <div className="flex flex-col items-center sm:items-start">
               ...
               <p className="text-slate-100 font-semibold text-sm">React & Flask</p>
               <p className="text-xs text-slate-400">Web Development</p>
             </div>
             <div className="flex flex-col items-center sm:items-start">
               <Brain className="w-8 h-8 text-purple-400 mb-2" />
               <p className="text-slate-100 font-semibold text-sm">LLM & CNN</p>
               <p className="text-xs text-slate-400">AI/Machine Learning</p>
             </div>
             <div className="flex flex-col items-center sm:items-start">
               <Database className="w-8 h-8 text-emerald-400 mb-2" />
               <p className="text-slate-100 font-semibold text-sm">MongoDB & MySQL</p>
               <p className="text-xs text-slate-400">Data Engineering</p>
             </div>
          </motion.div>
