...
import { Menu, X, Github, Linkedin, Mail, FileText, Phone, Folder, Briefcase } from 'lucide-react';
...
const Layout: React.FC = () => {
  ...
  const navLinks = [
    ...
    { path: '/experience', label: 'Experience', icon: <Briefcase className="w-4 h-4 mr-1" /> },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="flex-shrink-0 flex items-center">
              <NavLink to="/" className="text-xl font-bold bg-gradient-to-r from-emerald-400 to-blue-500 bg-clip-text text-transparent hover:scale-105 transition-transform uppercase tracking-tighter">
                PULLA SAIKIRAN
              </NavLink>
            </div>
